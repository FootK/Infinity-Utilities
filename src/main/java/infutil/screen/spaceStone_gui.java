...
public abstract class spaceStone_gui extends Screen {
    ...
    protected void init() {
        ...
        this.DimensionEdit = new EditBox(this.font, this.width / 2 - 150, 50, 300, 20, Component.translatable("advMode.command"));
...
// Coords
    ...
    // Z
        ...
        this.DimensionEdit.setMaxLength(32);
